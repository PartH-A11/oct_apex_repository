prompt --application/shared_components/navigation/lists/1st_dose_escalation_visit_week_3
begin
--   Manifest
--     LIST: 1st Dose Escalation Visit (Week 3)
--   Manifest End
...
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(11046679274754458724)
,p_name=>'1st Dose Escalation Visit (Week 3)'
,p_list_status=>'PUBLIC'
,p_version_scn=>1
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(11046681971765458726)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(11046682288827458727)
