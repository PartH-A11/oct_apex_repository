prompt --application/shared_components/user_interface/lovs/edc_patient_status_lov
begin
--   Manifest
--     EDC_PATIENT_STATUS_LOV
--   Manifest End
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(11046566388332126164)
,p_lov_name=>'EDC_PATIENT_STATUS_LOV'
