...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(11045178169972407881)
,p_theme_id=>26
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7998681145633417)
,p_page_template_id=>wwv_flow_imp.id(11045178169972407881)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7998789425633417)
,p_page_template_id=>wwv_flow_imp.id(11045178169972407881)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7998830849633417)
,p_page_template_id=>wwv_flow_imp.id(11045178169972407881)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7998911883633417)
,p_page_template_id=>wwv_flow_imp.id(11045178169972407881)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7999047741633417)
,p_page_template_id=>wwv_flow_imp.id(11045178169972407881)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7999109890633417)
,p_page_template_id=>wwv_flow_imp.id(11045178169972407881)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7999207838633417)
,p_page_template_id=>wwv_flow_imp.id(11045178169972407881)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7999368426633417)
,p_page_template_id=>wwv_flow_imp.id(11045178169972407881)
