...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(11045177275715407880)
,p_theme_id=>26
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7990176784633417)
,p_page_template_id=>wwv_flow_imp.id(11045177275715407880)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7990219979633417)
,p_page_template_id=>wwv_flow_imp.id(11045177275715407880)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7990346085633417)
,p_page_template_id=>wwv_flow_imp.id(11045177275715407880)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7990498075633417)
,p_page_template_id=>wwv_flow_imp.id(11045177275715407880)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7990567364633417)
,p_page_template_id=>wwv_flow_imp.id(11045177275715407880)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7990692697633417)
,p_page_template_id=>wwv_flow_imp.id(11045177275715407880)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7990711752633417)
,p_page_template_id=>wwv_flow_imp.id(11045177275715407880)
