...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(9916884921573203154)
,p_theme_id=>26
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7993458108633417)
,p_page_template_id=>wwv_flow_imp.id(9916884921573203154)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7993505155633417)
,p_page_template_id=>wwv_flow_imp.id(9916884921573203154)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7993606954633417)
,p_page_template_id=>wwv_flow_imp.id(9916884921573203154)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7993704993633417)
,p_page_template_id=>wwv_flow_imp.id(9916884921573203154)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7993802925633417)
,p_page_template_id=>wwv_flow_imp.id(9916884921573203154)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7993936773633417)
,p_page_template_id=>wwv_flow_imp.id(9916884921573203154)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7994005945633417)
,p_page_template_id=>wwv_flow_imp.id(9916884921573203154)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7994147997633417)
,p_page_template_id=>wwv_flow_imp.id(9916884921573203154)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7994275967633417)
,p_page_template_id=>wwv_flow_imp.id(9916884921573203154)
