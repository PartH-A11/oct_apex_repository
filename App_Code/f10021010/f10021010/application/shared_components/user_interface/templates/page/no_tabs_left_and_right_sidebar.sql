...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(11045177367913407880)
,p_theme_id=>26
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7989412835633417)
,p_page_template_id=>wwv_flow_imp.id(11045177367913407880)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7989590593633417)
,p_page_template_id=>wwv_flow_imp.id(11045177367913407880)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7989603983633417)
,p_page_template_id=>wwv_flow_imp.id(11045177367913407880)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7989712866633417)
,p_page_template_id=>wwv_flow_imp.id(11045177367913407880)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7989895952633417)
,p_page_template_id=>wwv_flow_imp.id(11045177367913407880)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7989916316633417)
,p_page_template_id=>wwv_flow_imp.id(11045177367913407880)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7990082771633417)
,p_page_template_id=>wwv_flow_imp.id(11045177367913407880)
