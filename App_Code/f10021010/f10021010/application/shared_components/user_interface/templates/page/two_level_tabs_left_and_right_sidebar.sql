...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(11045178674238407882)
,p_theme_id=>26
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7990885091633417)
,p_page_template_id=>wwv_flow_imp.id(11045178674238407882)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7990974216633417)
,p_page_template_id=>wwv_flow_imp.id(11045178674238407882)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7991006128633417)
,p_page_template_id=>wwv_flow_imp.id(11045178674238407882)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7991100372633417)
,p_page_template_id=>wwv_flow_imp.id(11045178674238407882)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7991293203633417)
,p_page_template_id=>wwv_flow_imp.id(11045178674238407882)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7991341978633417)
,p_page_template_id=>wwv_flow_imp.id(11045178674238407882)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7991430012633417)
,p_page_template_id=>wwv_flow_imp.id(11045178674238407882)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7991569664633417)
,p_page_template_id=>wwv_flow_imp.id(11045178674238407882)
