...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(11045178285714407881)
,p_theme_id=>26
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7997806566633417)
,p_page_template_id=>wwv_flow_imp.id(11045178285714407881)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7997944368633417)
,p_page_template_id=>wwv_flow_imp.id(11045178285714407881)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7998055728633417)
,p_page_template_id=>wwv_flow_imp.id(11045178285714407881)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7998143793633417)
,p_page_template_id=>wwv_flow_imp.id(11045178285714407881)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7998285281633417)
,p_page_template_id=>wwv_flow_imp.id(11045178285714407881)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7998312509633417)
,p_page_template_id=>wwv_flow_imp.id(11045178285714407881)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7998481661633417)
,p_page_template_id=>wwv_flow_imp.id(11045178285714407881)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7998584605633417)
,p_page_template_id=>wwv_flow_imp.id(11045178285714407881)
