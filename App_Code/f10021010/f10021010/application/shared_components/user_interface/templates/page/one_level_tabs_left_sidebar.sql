...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(11045177782486407880)
,p_theme_id=>26
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8001890159633417)
,p_page_template_id=>wwv_flow_imp.id(11045177782486407880)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8001935086633417)
,p_page_template_id=>wwv_flow_imp.id(11045177782486407880)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8002092110633417)
,p_page_template_id=>wwv_flow_imp.id(11045177782486407880)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8002194119633417)
,p_page_template_id=>wwv_flow_imp.id(11045177782486407880)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8002282511633417)
,p_page_template_id=>wwv_flow_imp.id(11045177782486407880)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8002325083633417)
,p_page_template_id=>wwv_flow_imp.id(11045177782486407880)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8002440219633417)
,p_page_template_id=>wwv_flow_imp.id(11045177782486407880)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8002535677633417)
,p_page_template_id=>wwv_flow_imp.id(11045177782486407880)
