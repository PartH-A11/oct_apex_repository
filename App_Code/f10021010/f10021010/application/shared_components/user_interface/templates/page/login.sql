...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(11045177065054407876)
,p_theme_id=>26
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7992376410633417)
,p_page_template_id=>wwv_flow_imp.id(11045177065054407876)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7992499654633417)
,p_page_template_id=>wwv_flow_imp.id(11045177065054407876)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7992525924633417)
,p_page_template_id=>wwv_flow_imp.id(11045177065054407876)
