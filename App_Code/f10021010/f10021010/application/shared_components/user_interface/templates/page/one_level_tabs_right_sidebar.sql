...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(11045178084067407881)
,p_theme_id=>26
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7999491495633417)
,p_page_template_id=>wwv_flow_imp.id(11045178084067407881)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7999566117633417)
,p_page_template_id=>wwv_flow_imp.id(11045178084067407881)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7999601299633417)
,p_page_template_id=>wwv_flow_imp.id(11045178084067407881)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7999739362633417)
,p_page_template_id=>wwv_flow_imp.id(11045178084067407881)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7999848608633417)
,p_page_template_id=>wwv_flow_imp.id(11045178084067407881)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7999904990633417)
,p_page_template_id=>wwv_flow_imp.id(11045178084067407881)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8000003770633417)
,p_page_template_id=>wwv_flow_imp.id(11045178084067407881)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8000149861633417)
,p_page_template_id=>wwv_flow_imp.id(11045178084067407881)
