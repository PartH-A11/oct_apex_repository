...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(11045178458841407882)
,p_theme_id=>26
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7995412348633417)
,p_page_template_id=>wwv_flow_imp.id(11045178458841407882)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7995546372633417)
,p_page_template_id=>wwv_flow_imp.id(11045178458841407882)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7995652085633417)
,p_page_template_id=>wwv_flow_imp.id(11045178458841407882)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7995728927633417)
,p_page_template_id=>wwv_flow_imp.id(11045178458841407882)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7995883894633417)
,p_page_template_id=>wwv_flow_imp.id(11045178458841407882)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7995907335633417)
,p_page_template_id=>wwv_flow_imp.id(11045178458841407882)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7996055514633417)
,p_page_template_id=>wwv_flow_imp.id(11045178458841407882)
