...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(11045177967597407881)
,p_theme_id=>26
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8000266616633417)
,p_page_template_id=>wwv_flow_imp.id(11045177967597407881)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8000336676633417)
,p_page_template_id=>wwv_flow_imp.id(11045177967597407881)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8000424229633417)
,p_page_template_id=>wwv_flow_imp.id(11045177967597407881)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8000595591633417)
,p_page_template_id=>wwv_flow_imp.id(11045177967597407881)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8000601012633417)
,p_page_template_id=>wwv_flow_imp.id(11045177967597407881)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8000743289633417)
,p_page_template_id=>wwv_flow_imp.id(11045177967597407881)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8000895817633417)
,p_page_template_id=>wwv_flow_imp.id(11045177967597407881)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8000904772633417)
,p_page_template_id=>wwv_flow_imp.id(11045177967597407881)
