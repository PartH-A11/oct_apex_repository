...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(11045177857932407881)
,p_theme_id=>26
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8001031027633417)
,p_page_template_id=>wwv_flow_imp.id(11045177857932407881)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8001156213633417)
,p_page_template_id=>wwv_flow_imp.id(11045177857932407881)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8001230486633417)
,p_page_template_id=>wwv_flow_imp.id(11045177857932407881)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8001381359633417)
,p_page_template_id=>wwv_flow_imp.id(11045177857932407881)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8001495494633417)
,p_page_template_id=>wwv_flow_imp.id(11045177857932407881)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8001534979633417)
,p_page_template_id=>wwv_flow_imp.id(11045177857932407881)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8001632544633417)
,p_page_template_id=>wwv_flow_imp.id(11045177857932407881)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8001799698633417)
,p_page_template_id=>wwv_flow_imp.id(11045177857932407881)
