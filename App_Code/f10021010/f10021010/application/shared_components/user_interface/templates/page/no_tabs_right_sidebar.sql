...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(11045177560262407880)
,p_theme_id=>26
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8003488815633417)
,p_page_template_id=>wwv_flow_imp.id(11045177560262407880)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8003558692633417)
,p_page_template_id=>wwv_flow_imp.id(11045177560262407880)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8003654473633417)
,p_page_template_id=>wwv_flow_imp.id(11045177560262407880)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8003719376633417)
,p_page_template_id=>wwv_flow_imp.id(11045177560262407880)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8003861414633417)
,p_page_template_id=>wwv_flow_imp.id(11045177560262407880)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8003960628633417)
,p_page_template_id=>wwv_flow_imp.id(11045177560262407880)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8004068162633417)
,p_page_template_id=>wwv_flow_imp.id(11045177560262407880)
