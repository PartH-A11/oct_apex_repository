...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(11045178788903407882)
,p_theme_id=>26
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7997007096633417)
,p_page_template_id=>wwv_flow_imp.id(11045178788903407882)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7997194751633417)
,p_page_template_id=>wwv_flow_imp.id(11045178788903407882)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7997265907633417)
,p_page_template_id=>wwv_flow_imp.id(11045178788903407882)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7997385284633417)
,p_page_template_id=>wwv_flow_imp.id(11045178788903407882)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7997440321633417)
,p_page_template_id=>wwv_flow_imp.id(11045178788903407882)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7997514075633417)
,p_page_template_id=>wwv_flow_imp.id(11045178788903407882)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7997632139633417)
,p_page_template_id=>wwv_flow_imp.id(11045178788903407882)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7997716428633417)
,p_page_template_id=>wwv_flow_imp.id(11045178788903407882)
