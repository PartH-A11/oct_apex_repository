...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(11045177478759407880)
,p_theme_id=>26
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7988774438633417)
,p_page_template_id=>wwv_flow_imp.id(11045177478759407880)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7988874740633417)
,p_page_template_id=>wwv_flow_imp.id(11045177478759407880)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7988963333633417)
,p_page_template_id=>wwv_flow_imp.id(11045177478759407880)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7989074253633417)
,p_page_template_id=>wwv_flow_imp.id(11045177478759407880)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7989190013633417)
,p_page_template_id=>wwv_flow_imp.id(11045177478759407880)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7989260020633417)
,p_page_template_id=>wwv_flow_imp.id(11045177478759407880)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7989304430633417)
,p_page_template_id=>wwv_flow_imp.id(11045177478759407880)
