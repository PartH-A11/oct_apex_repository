...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(11045178875093407883)
,p_theme_id=>26
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7994602495633417)
,p_page_template_id=>wwv_flow_imp.id(11045178875093407883)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7994753275633417)
,p_page_template_id=>wwv_flow_imp.id(11045178875093407883)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7994872635633417)
,p_page_template_id=>wwv_flow_imp.id(11045178875093407883)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7994992352633417)
,p_page_template_id=>wwv_flow_imp.id(11045178875093407883)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7995037756633417)
,p_page_template_id=>wwv_flow_imp.id(11045178875093407883)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7995122470633417)
,p_page_template_id=>wwv_flow_imp.id(11045178875093407883)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7995217240633417)
,p_page_template_id=>wwv_flow_imp.id(11045178875093407883)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7995368916633417)
,p_page_template_id=>wwv_flow_imp.id(11045178875093407883)
