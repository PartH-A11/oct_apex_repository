...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(11045178567368407882)
,p_theme_id=>26
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7992692355633417)
,p_page_template_id=>wwv_flow_imp.id(11045178567368407882)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7992705834633417)
,p_page_template_id=>wwv_flow_imp.id(11045178567368407882)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7992886988633417)
,p_page_template_id=>wwv_flow_imp.id(11045178567368407882)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7992991910633417)
,p_page_template_id=>wwv_flow_imp.id(11045178567368407882)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7993059248633417)
,p_page_template_id=>wwv_flow_imp.id(11045178567368407882)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7993117728633417)
,p_page_template_id=>wwv_flow_imp.id(11045178567368407882)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7993293207633417)
,p_page_template_id=>wwv_flow_imp.id(11045178567368407882)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7993392605633417)
,p_page_template_id=>wwv_flow_imp.id(11045178567368407882)
