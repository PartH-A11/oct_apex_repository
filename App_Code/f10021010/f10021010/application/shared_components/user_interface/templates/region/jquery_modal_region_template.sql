...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(11045182462990407888)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26858227730642564)
,p_plug_template_id=>wwv_flow_imp.id(11045182462990407888)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26858311731642564)
,p_plug_template_id=>wwv_flow_imp.id(11045182462990407888)
,p_name=>'Sub Regions'
