...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(11045179465801407886)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26880958737642564)
,p_plug_template_id=>wwv_flow_imp.id(11045179465801407886)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26881004712642564)
,p_plug_template_id=>wwv_flow_imp.id(11045179465801407886)
,p_name=>'Sub Regions'
