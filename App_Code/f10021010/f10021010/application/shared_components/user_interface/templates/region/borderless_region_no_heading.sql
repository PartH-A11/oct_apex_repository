...
begin
--   Manifest
--     REGION TEMPLATE: BORDERLESS_REGION_NO_HEADING
--   Manifest End
...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(11045179264140407886)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26882404350642564)
,p_plug_template_id=>wwv_flow_imp.id(11045179264140407886)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26882591517642564)
,p_plug_template_id=>wwv_flow_imp.id(11045179264140407886)
,p_name=>'Sub Regions'
