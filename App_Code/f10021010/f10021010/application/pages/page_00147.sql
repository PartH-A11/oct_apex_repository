...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1817412639823542795)
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'data_load_def_id', wwv_flow_imp.id(1817390873354542787))).to_clob
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1817414804169542795)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(1817413575848542795)
,p_button_name=>'NEXT'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1817414556187542795)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1817414003408542795)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(1817415631395542796)
,p_branch_action=>'f?p=&APP_ID.:150:&APP_SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(1817414804169542795)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(1817416020622542796)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1817415293380542796)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PREPARE_UPLOADED_DATA'
,p_process_name=>'Prepare Uploaded Data'
,p_attribute_01=>wwv_flow_imp.id(1817390873354542787)
...
,p_process_when_button_id=>wwv_flow_imp.id(1817414804169542795)
