...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(10553301823091850736)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(10553302211864850739)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(10553302621273850739)
,p_plug_name=>'TEMP'
,p_parent_plug_id=>wwv_flow_imp.id(10553302211864850739)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(10553303386261850741)
,p_plug_name=>'&APP_PAGE_NAME.'
,p_parent_plug_id=>wwv_flow_imp.id(10553302621273850739)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(11045180167451407887)
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(10553313395320850754)
,p_plug_name=>'Audit'
,p_parent_plug_id=>wwv_flow_imp.id(10553302621273850739)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(10553303807664850742)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(10553303386261850741)
,p_button_name=>'SAVE'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(10553304237346850743)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(10553304602264850743)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(10553305005751850744)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(10553305420489850744)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(10553305787973850745)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(10553306205262850745)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(10553306630746850745)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(10553306951790850746)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(10553307364137850746)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(10553307813607850746)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(10553321482197850767)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10553302959850850740)
,p_name=>'P501_SECTION_STATUS'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(10553302621273850739)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10553308190241850747)
,p_name=>'P501_NO_OF_QUERIES'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(10553303386261850741)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10553309025447850747)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10553309409992850748)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10553313748113850754)
,p_name=>'P501_CREATED_BY'
,p_item_sequence=>170
,p_item_plug_id=>wwv_flow_imp.id(10553313395320850754)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10553314154508850755)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10553314560430850755)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10553315002161850756)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10553328919330928782)
,p_name=>'P501_XIC_ID'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(10553303386261850741)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10553329224224928789)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10553329636074928790)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10553392876864208718)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10553393219584208718)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10553559845917676258)
,p_name=>'P501_IMG'
,p_item_sequence=>11
,p_item_plug_id=>wwv_flow_imp.id(10553302621273850739)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(10553315801707850760)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(10553465793869460468)
...
,p_when_button_pressed=>wwv_flow_imp.id(10553303807664850742)
,p_associated_item=>wwv_flow_imp.id(10553392876864208718)
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(10553467982303465198)
...
,p_validation_condition_type=>'FUNCTION_BODY'
,p_when_button_pressed=>wwv_flow_imp.id(10553303807664850742)
,p_associated_item=>wwv_flow_imp.id(10553393219584208718)
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(10558181164296332368)
...
,p_associated_item=>wwv_flow_imp.id(10553329224224928789)
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(10558181305530332369)
...
,p_associated_item=>wwv_flow_imp.id(10553329636074928790)
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(10553568848057721669)
,p_name=>'Audit'
,p_event_sequence=>1
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(10553569297898721669)
,p_event_id=>wwv_flow_imp.id(10553568848057721669)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(10553410240484373488)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(10553410641592373489)
,p_event_id=>wwv_flow_imp.id(10553410240484373488)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(10553412138503377991)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(10553412455055377992)
,p_event_id=>wwv_flow_imp.id(10553412138503377991)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SHOW'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(10553412972895384116)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(10553413402746384116)
,p_event_id=>wwv_flow_imp.id(10553412972895384116)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(10553414142572388817)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(10553414547065388817)
,p_event_id=>wwv_flow_imp.id(10553414142572388817)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_HIDE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(10543489636718986209)
,p_name=>'Lock modal page'
,p_event_sequence=>50
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(10553307364137850746)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(10543489981498986210)
,p_event_id=>wwv_flow_imp.id(10543489636718986209)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'PLUGIN_COM_SKILLBUILDERS_MODAL_PAGE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(10543501680903120460)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(10543502141730120461)
,p_event_id=>wwv_flow_imp.id(10543501680903120460)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(10543542254626510796)
,p_name=>'Unlock Modal Page'
,p_event_sequence=>70
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(10553307813607850746)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(10543542603844510797)
,p_event_id=>wwv_flow_imp.id(10543542254626510796)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'PLUGIN_COM_SKILLBUILDERS_MODAL_PAGE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(10553336070905928795)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(10568823623960756982)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(10553336495789928796)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(10572304260343713268)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(10553317330415850762)
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(10553306205262850745)
,p_process_success_message=>'Submitted for Monitoring.'
,p_internal_uid=>10553317330415850762
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(10553317691873850762)
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(10553306630746850745)
,p_process_success_message=>'Section Monitored.'
,p_internal_uid=>10553317691873850762
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(10553318022226850763)
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(10553306951790850746)
,p_process_success_message=>'Section reviewed.'
,p_internal_uid=>10553318022226850763
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(10553318345534850763)
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(10553307364137850746)
,p_process_success_message=>'Section Locked.'
,p_internal_uid=>10553318345534850763
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(10553318774521850763)
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(10553307813607850746)
,p_process_success_message=>'Section unlocked.'
,p_internal_uid=>10553318774521850763
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(10553316929361850762)
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(10553305787973850745)
