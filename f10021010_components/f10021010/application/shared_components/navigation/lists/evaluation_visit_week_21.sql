prompt --application/shared_components/navigation/lists/evaluation_visit_week_21
begin
--   Manifest
--     LIST: Evaluation Visit (Week 21)
--   Manifest End
...
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(12147713939038171356)
,p_name=>'Evaluation Visit (Week 21)'
,p_list_status=>'PUBLIC'
,p_version_scn=>1
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(12147715449424171357)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(12147715736037171357)
