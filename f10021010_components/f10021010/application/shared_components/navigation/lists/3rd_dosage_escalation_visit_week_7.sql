prompt --application/shared_components/navigation/lists/3rd_dosage_escalation_visit_week_7
begin
--   Manifest
--     LIST: 3rd Dosage Escalation Visit (Week 7)
--   Manifest End
...
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(12147677137427075959)
,p_name=>'3rd Dosage Escalation Visit (Week 7)'
,p_list_status=>'PUBLIC'
,p_version_scn=>1
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(12147680138243075961)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(12147680436101075962)
