...
wwv_flow_imp_shared.create_tab(
 p_id=>wwv_flow_imp.id(12146822642235472357)
,p_tab_set=>'TS1'
,p_tab_sequence=>20
...
wwv_flow_imp_shared.create_tab(
 p_id=>wwv_flow_imp.id(12146822931452477305)
,p_tab_set=>'TS1'
,p_tab_sequence=>30
...
wwv_flow_imp_shared.create_tab(
 p_id=>wwv_flow_imp.id(12152736642876509137)
,p_tab_set=>'TS1'
,p_tab_sequence=>30
...
wwv_flow_imp_shared.create_tab(
 p_id=>wwv_flow_imp.id(12147744247869811791)
,p_tab_set=>'TS1'
,p_tab_sequence=>50
...
wwv_flow_imp_shared.create_tab(
 p_id=>wwv_flow_imp.id(12161496131279650789)
,p_tab_set=>'TS1'
,p_tab_sequence=>60
,p_tab_name=>'Reports'
,p_tab_text=>'Reports'
...
wwv_flow_imp_shared.create_tab(
 p_id=>wwv_flow_imp.id(12146825341742548489)
,p_tab_set=>'TS1'
,p_tab_sequence=>70
...
wwv_flow_imp_shared.create_tab(
 p_id=>wwv_flow_imp.id(5172640933886976903)
,p_tab_set=>'TS1'
,p_tab_sequence=>80
