...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(12146127953651911972)
,p_theme_id=>26
,p_name=>'Minimal Page'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108942432556137510)
,p_page_template_id=>wwv_flow_imp.id(12146127953651911972)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108942488093137510)
,p_page_template_id=>wwv_flow_imp.id(12146127953651911972)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108942636275137510)
,p_page_template_id=>wwv_flow_imp.id(12146127953651911972)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108942692976137510)
,p_page_template_id=>wwv_flow_imp.id(12146127953651911972)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108942853735137510)
,p_page_template_id=>wwv_flow_imp.id(12146127953651911972)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108942958652137510)
,p_page_template_id=>wwv_flow_imp.id(12146127953651911972)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108943033819137510)
,p_page_template_id=>wwv_flow_imp.id(12146127953651911972)
