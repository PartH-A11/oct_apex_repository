...
begin
--   Manifest
--     TEMPLATE: ONE_LEVEL_TABS_LEFT_AND_RIGHT_SIDEBAR
--   Manifest End
...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(12146128626073911974)
,p_theme_id=>26
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108951799169137510)
,p_page_template_id=>wwv_flow_imp.id(12146128626073911974)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108951924355137510)
,p_page_template_id=>wwv_flow_imp.id(12146128626073911974)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108951998628137510)
,p_page_template_id=>wwv_flow_imp.id(12146128626073911974)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108952149501137510)
,p_page_template_id=>wwv_flow_imp.id(12146128626073911974)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108952263636137510)
,p_page_template_id=>wwv_flow_imp.id(12146128626073911974)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108952303121137510)
,p_page_template_id=>wwv_flow_imp.id(12146128626073911974)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108952400686137510)
,p_page_template_id=>wwv_flow_imp.id(12146128626073911974)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108952567840137510)
,p_page_template_id=>wwv_flow_imp.id(12146128626073911974)
