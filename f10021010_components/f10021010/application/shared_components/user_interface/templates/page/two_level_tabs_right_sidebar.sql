...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(12146129643234911976)
,p_theme_id=>26
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108945370637137510)
,p_page_template_id=>wwv_flow_imp.id(12146129643234911976)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108945521417137510)
,p_page_template_id=>wwv_flow_imp.id(12146129643234911976)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108945640777137510)
,p_page_template_id=>wwv_flow_imp.id(12146129643234911976)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108945760494137510)
,p_page_template_id=>wwv_flow_imp.id(12146129643234911976)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108945805898137510)
,p_page_template_id=>wwv_flow_imp.id(12146129643234911976)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108945890612137510)
,p_page_template_id=>wwv_flow_imp.id(12146129643234911976)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108945985382137510)
,p_page_template_id=>wwv_flow_imp.id(12146129643234911976)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108946137058137510)
,p_page_template_id=>wwv_flow_imp.id(12146129643234911976)
