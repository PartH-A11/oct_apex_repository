...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(12146128043856911973)
,p_theme_id=>26
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108940944926137510)
,p_page_template_id=>wwv_flow_imp.id(12146128043856911973)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108940988121137510)
,p_page_template_id=>wwv_flow_imp.id(12146128043856911973)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108941114227137510)
,p_page_template_id=>wwv_flow_imp.id(12146128043856911973)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108941266217137510)
,p_page_template_id=>wwv_flow_imp.id(12146128043856911973)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108941335506137510)
,p_page_template_id=>wwv_flow_imp.id(12146128043856911973)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108941460839137510)
,p_page_template_id=>wwv_flow_imp.id(12146128043856911973)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108941479894137510)
,p_page_template_id=>wwv_flow_imp.id(12146128043856911973)
