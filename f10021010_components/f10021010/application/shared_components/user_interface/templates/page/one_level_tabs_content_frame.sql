...
begin
--   Manifest
--     TEMPLATE: ONE_LEVEL_TABS_CONTENT_FRAME
--   Manifest End
...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(12146128437217911973)
,p_theme_id=>26
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108953414975137510)
,p_page_template_id=>wwv_flow_imp.id(12146128437217911973)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108953558234137510)
,p_page_template_id=>wwv_flow_imp.id(12146128437217911973)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108953585834137510)
,p_page_template_id=>wwv_flow_imp.id(12146128437217911973)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108953685134137510)
,p_page_template_id=>wwv_flow_imp.id(12146128437217911973)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108953823562137510)
,p_page_template_id=>wwv_flow_imp.id(12146128437217911973)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108953898208137510)
,p_page_template_id=>wwv_flow_imp.id(12146128437217911973)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108954050790137510)
,p_page_template_id=>wwv_flow_imp.id(12146128437217911973)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108954068979137510)
,p_page_template_id=>wwv_flow_imp.id(12146128437217911973)
