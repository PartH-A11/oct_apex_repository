...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(12146129557044911975)
,p_theme_id=>26
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108947775238137510)
,p_page_template_id=>wwv_flow_imp.id(12146129557044911975)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108947962893137510)
,p_page_template_id=>wwv_flow_imp.id(12146129557044911975)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108948034049137510)
,p_page_template_id=>wwv_flow_imp.id(12146129557044911975)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108948153426137510)
,p_page_template_id=>wwv_flow_imp.id(12146129557044911975)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108948208463137510)
,p_page_template_id=>wwv_flow_imp.id(12146129557044911975)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108948282217137510)
,p_page_template_id=>wwv_flow_imp.id(12146129557044911975)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108948400281137510)
,p_page_template_id=>wwv_flow_imp.id(12146129557044911975)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108948484570137510)
,p_page_template_id=>wwv_flow_imp.id(12146129557044911975)
