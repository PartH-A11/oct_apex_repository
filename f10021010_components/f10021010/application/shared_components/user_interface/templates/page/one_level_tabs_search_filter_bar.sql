...
begin
--   Manifest
--     TEMPLATE: ONE_LEVEL_TABS_SEARCH_FILTER_BAR
--   Manifest End
...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(12146128938113911974)
,p_theme_id=>26
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108949449287137510)
,p_page_template_id=>wwv_flow_imp.id(12146128938113911974)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108949557567137510)
,p_page_template_id=>wwv_flow_imp.id(12146128938113911974)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108949598991137510)
,p_page_template_id=>wwv_flow_imp.id(12146128938113911974)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108949680025137510)
,p_page_template_id=>wwv_flow_imp.id(12146128938113911974)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108949815883137510)
,p_page_template_id=>wwv_flow_imp.id(12146128938113911974)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108949878032137510)
,p_page_template_id=>wwv_flow_imp.id(12146128938113911974)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108949975980137510)
,p_page_template_id=>wwv_flow_imp.id(12146128938113911974)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108950136568137510)
,p_page_template_id=>wwv_flow_imp.id(12146128938113911974)
