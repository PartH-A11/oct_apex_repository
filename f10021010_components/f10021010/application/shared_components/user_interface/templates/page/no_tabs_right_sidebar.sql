...
begin
--   Manifest
--     TEMPLATE: NO_TABS_RIGHT_SIDEBAR
--   Manifest End
...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(12146128328403911973)
,p_theme_id=>26
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108954256957137510)
,p_page_template_id=>wwv_flow_imp.id(12146128328403911973)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108954326834137510)
,p_page_template_id=>wwv_flow_imp.id(12146128328403911973)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108954422615137510)
,p_page_template_id=>wwv_flow_imp.id(12146128328403911973)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108954487518137510)
,p_page_template_id=>wwv_flow_imp.id(12146128328403911973)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108954629556137510)
,p_page_template_id=>wwv_flow_imp.id(12146128328403911973)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108954728770137510)
,p_page_template_id=>wwv_flow_imp.id(12146128328403911973)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108954836304137510)
,p_page_template_id=>wwv_flow_imp.id(12146128328403911973)
