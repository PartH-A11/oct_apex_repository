prompt --application/shared_components/user_interface/templates/page/popup_1_column
begin
--   Manifest
--     TEMPLATE: POPUP_1_COLUMN
--   Manifest End
...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(11017835689714707247)
,p_theme_id=>26
,p_name=>'Popup_1_Column'
,p_internal_name=>'POPUP_1_COLUMN'
,p_is_popup=>false
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108944226250137510)
,p_page_template_id=>wwv_flow_imp.id(11017835689714707247)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108944273297137510)
,p_page_template_id=>wwv_flow_imp.id(11017835689714707247)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108944375096137510)
,p_page_template_id=>wwv_flow_imp.id(11017835689714707247)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108944473135137510)
,p_page_template_id=>wwv_flow_imp.id(11017835689714707247)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108944571067137510)
,p_page_template_id=>wwv_flow_imp.id(11017835689714707247)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108944704915137510)
,p_page_template_id=>wwv_flow_imp.id(11017835689714707247)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108944774087137510)
,p_page_template_id=>wwv_flow_imp.id(11017835689714707247)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108944916139137510)
,p_page_template_id=>wwv_flow_imp.id(11017835689714707247)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108945044109137510)
,p_page_template_id=>wwv_flow_imp.id(11017835689714707247)
