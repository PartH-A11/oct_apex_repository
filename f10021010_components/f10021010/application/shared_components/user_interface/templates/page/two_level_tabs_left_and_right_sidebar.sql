...
begin
--   Manifest
--     TEMPLATE: TWO_LEVEL_TABS_LEFT_AND_RIGHT_SIDEBAR
--   Manifest End
...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(12146129442379911975)
,p_theme_id=>26
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108941653233137510)
,p_page_template_id=>wwv_flow_imp.id(12146129442379911975)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108941742358137510)
,p_page_template_id=>wwv_flow_imp.id(12146129442379911975)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108941774270137510)
,p_page_template_id=>wwv_flow_imp.id(12146129442379911975)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108941868514137510)
,p_page_template_id=>wwv_flow_imp.id(12146129442379911975)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108942061345137510)
,p_page_template_id=>wwv_flow_imp.id(12146129442379911975)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108942110120137510)
,p_page_template_id=>wwv_flow_imp.id(12146129442379911975)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108942198154137510)
,p_page_template_id=>wwv_flow_imp.id(12146129442379911975)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108942337806137510)
,p_page_template_id=>wwv_flow_imp.id(12146129442379911975)
