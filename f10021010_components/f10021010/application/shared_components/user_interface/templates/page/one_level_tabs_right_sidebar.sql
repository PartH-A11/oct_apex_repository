...
begin
--   Manifest
--     TEMPLATE: ONE_LEVEL_TABS_RIGHT_SIDEBAR
--   Manifest End
...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(12146128852208911974)
,p_theme_id=>26
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108950259637137510)
,p_page_template_id=>wwv_flow_imp.id(12146128852208911974)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108950334259137510)
,p_page_template_id=>wwv_flow_imp.id(12146128852208911974)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108950369441137510)
,p_page_template_id=>wwv_flow_imp.id(12146128852208911974)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108950507504137510)
,p_page_template_id=>wwv_flow_imp.id(12146128852208911974)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108950616750137510)
,p_page_template_id=>wwv_flow_imp.id(12146128852208911974)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108950673132137510)
,p_page_template_id=>wwv_flow_imp.id(12146128852208911974)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108950771912137510)
,p_page_template_id=>wwv_flow_imp.id(12146128852208911974)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108950918003137510)
,p_page_template_id=>wwv_flow_imp.id(12146128852208911974)
