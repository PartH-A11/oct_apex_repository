...
begin
--   Manifest
--     TEMPLATE: NO_TABS_LEFT_AND_RIGHT_SIDEBAR
--   Manifest End
...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(12146128136054911973)
,p_theme_id=>26
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108940180977137510)
,p_page_template_id=>wwv_flow_imp.id(12146128136054911973)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108940358735137510)
,p_page_template_id=>wwv_flow_imp.id(12146128136054911973)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108940372125137510)
,p_page_template_id=>wwv_flow_imp.id(12146128136054911973)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108940481008137510)
,p_page_template_id=>wwv_flow_imp.id(12146128136054911973)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108940664094137510)
,p_page_template_id=>wwv_flow_imp.id(12146128136054911973)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108940684458137510)
,p_page_template_id=>wwv_flow_imp.id(12146128136054911973)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108940850913137510)
,p_page_template_id=>wwv_flow_imp.id(12146128136054911973)
