...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(12146129126910911975)
,p_theme_id=>26
,p_name=>'Popup'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108946965858137510)
,p_page_template_id=>wwv_flow_imp.id(12146129126910911975)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108947014001137510)
,p_page_template_id=>wwv_flow_imp.id(12146129126910911975)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108947074349137510)
,p_page_template_id=>wwv_flow_imp.id(12146129126910911975)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108947251184137510)
,p_page_template_id=>wwv_flow_imp.id(12146129126910911975)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108947294596137510)
,p_page_template_id=>wwv_flow_imp.id(12146129126910911975)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108947456494137510)
,p_page_template_id=>wwv_flow_imp.id(12146129126910911975)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108947473918137510)
,p_page_template_id=>wwv_flow_imp.id(12146129126910911975)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108947648975137510)
,p_page_template_id=>wwv_flow_imp.id(12146129126910911975)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1108947740007137510)
,p_page_template_id=>wwv_flow_imp.id(12146129126910911975)
