...
begin
--   Manifest
--     REGION TEMPLATE: ACCESSIBLE_REGION_WITH_HEADING
--   Manifest End
...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(12146129741780911976)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1127836047449146657)
,p_plug_template_id=>wwv_flow_imp.id(12146129741780911976)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1127836134959146657)
,p_plug_template_id=>wwv_flow_imp.id(12146129741780911976)
,p_name=>'Sub Regions'
