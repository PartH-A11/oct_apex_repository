...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(12150612650443769488)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1127808824648146657)
,p_plug_template_id=>wwv_flow_imp.id(12150612650443769488)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1127808940762146657)
,p_plug_template_id=>wwv_flow_imp.id(12150612650443769488)
,p_name=>'Sub Regions'
