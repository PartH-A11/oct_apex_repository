...
begin
--   Manifest
--     REGION TEMPLATE: INTERACTIVE_REPORT_REGION
--   Manifest End
...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(12146131340165911980)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1127822368276146657)
,p_plug_template_id=>wwv_flow_imp.id(12146131340165911980)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1127822556642146657)
,p_plug_template_id=>wwv_flow_imp.id(12146131340165911980)
,p_name=>'Sub Regions'
