...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(12146133231131911981)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1127808995872146657)
,p_plug_template_id=>wwv_flow_imp.id(12146133231131911981)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1127809079873146657)
,p_plug_template_id=>wwv_flow_imp.id(12146133231131911981)
,p_name=>'Sub Regions'
