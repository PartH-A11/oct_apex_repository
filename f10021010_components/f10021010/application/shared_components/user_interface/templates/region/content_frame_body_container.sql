...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(12146130726888911980)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1127836192818146657)
,p_plug_template_id=>wwv_flow_imp.id(12146130726888911980)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1127836358507146657)
,p_plug_template_id=>wwv_flow_imp.id(12146130726888911980)
,p_name=>'Sub Regions'
