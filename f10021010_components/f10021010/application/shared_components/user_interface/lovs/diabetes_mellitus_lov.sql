...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(11447471874949502596)
,p_lov_name=>'DIABETES_MELLITUS_LOV'
,p_lov_query=>'.'||wwv_flow_imp.id(11447471874949502596)||'.'
,p_location=>'STATIC'
,p_version_scn=>1
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(11447472220664502597)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Non-IDDM'
,p_lov_return_value=>'Non-IDDM'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(11447472544966502597)
